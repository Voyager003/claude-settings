---
name: mermaid
description: Generate Mermaid diagrams from user requirements. Use when the user asks for "$mermaid", Mermaid code, flowcharts, sequence diagrams, class diagrams, ER diagrams, Gantt charts, or other Mermaid-supported diagrams.
origin: WH-2099/mermaid-skill (MIT, commit d3a68ba)
---
...
- Default to returning Mermaid code in the response.
- Before writing or editing any file, ask the user to confirm the target path and exact file action.
- When the user confirms file output, prefer `.mmd` for standalone diagrams or update the explicitly requested Markdown document.
...
Use the user's current request as the diagram requirements.
