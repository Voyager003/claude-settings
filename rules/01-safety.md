# rules/01-safety.md — SAFETY & APPROVALS (NON-NEGOTIABLE)
...
- Prohibited bypass techniques: string concatenation, variable substitution, eval, aliasing, encoding, or any indirect execution.
